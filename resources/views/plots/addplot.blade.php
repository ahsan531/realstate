...
@section('container')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span>Add Plots</h4>
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Add Plots Details</h5>

                    </div>
                    <div class="card-body">
                        <form id="foamsubmit" method="POST" action="{{ route('viewplots.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="basic-default-fullname">
                                            <label class="form-label " for="basic-default-company">Block</label> <span class='text-danger'>*</span>
                                        </label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="size_yard">Size In Sq Yard</label>
                                        <input type="text" class="form-control" name="size_in_yard" id="size_yard"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="Plot_No">Plot No</label><span
                                            class='text-danger'>*</span>
                                        <div class="input-group input-group-merge">
                                            <input type="text" id="Plot_No" name="plot_no" class="form-control"
                                                placeholder="Plot_No" onkeydown="checkval();">
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="basic-default-phone" name="size_marla"
                                            class="form-control phone-mask" placeholder="Enter Your Required Size">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="Facing">Facing</label>
                                        <div class="input-group input-group-merge">
                                            <input type="text" id="Facing" name="facing" class="form-control"
                                                placeholder="Facing">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select2bs4" name="type" id="type"
                                            ...
                                            <option value="Vip Farm House">Vip Farm House</option>
                            ...
                            <input class="btn btn-primary" id="sdkjsdjdsj" type="button" onclick="for_submit();"
                                value="submit">
