                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($customers as $key => $customer)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>
                                    <image style="width:100px;" src="{{ url('uploads/uploads/' . $customer->customer_img) }}" />
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href='{{ url("editcustomer/$customer->id") }}'><i
                                                    class="bx bx-edit-alt me-1"></i>Edit</a>
                                            <a class="dropdown-item" href="javascript:;"
                                                onclick="delete_model({{ $customer->id }})">
